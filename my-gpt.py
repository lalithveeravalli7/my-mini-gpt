...
#dataset to train on. Using tiny shakespeare dataset
# !wget https://raw.githubusercontent.com/lalithveeravalli7/my-mini-gpt/main/input.txt
...
class BigramLanguageModel(nn.Module):
  ...
  def generate(self, idx, max_new_tokens):
    # idx is (B,T) array of indices in the curret context
